...
objects, as it avoids loading all data into memory.
...
chromatograms (EIC) from spectral data:

```{r, eval=FALSE}
library(Spectra)

## Create TIC (default)
chr_tic <- Chromatograms(sp, summarize.method = "sum")

## Create BPC
chr_bpc <- Chromatograms(sp, summarize.method = "max")

## Create with custom factorization
chr_custom <- Chromatograms(sp, 
