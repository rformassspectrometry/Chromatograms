...
[![years in bioc](http://bioconductor.org/shields/years-in-bioc/Chromatograms.svg)](https://bioconductor.org/packages/release/bioc/html/Chromatograms.html)
...
Spectrometry*](https://www.rformassspectrometry.org/) initiative, provides a
powerful and expandable infrastructure for handling and analysing
chromatographic mass spectrometry (MS) data.

It will replace the legacy classes to handle chromatographic data in R provided
by the [*MSnbase*](http://lgatto.github.io/MSnbase/index.html) package.
...
be afraid - we're friendly ☺️! 👉 get involved by opening an [issue](https://github.com/rformassspectrometry/Chromatograms/issues).
